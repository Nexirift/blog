![tailwind-nextjs-banner](/public/static/images/social-card.jpg)

# Nexirift Blog

This is a [Next.js](https://nextjs.org/), [Tailwind CSS](https://tailwindcss.com/) blogging site. Version 2 is based on Next App directory with [React Server Component](https://nextjs.org/docs/getting-started/react-essentials#server-components) and uses [Contentlayer](https://www.contentlayer.dev/) to manage markdown content.
...
[MIT](https://github.com/Nexirift/blog/blob/main/LICENSE) © [Timothy Lin](https://www.timlrx.com)
