...
We also aim to be fully transparent about the way our platform is run, this includes the various "flags" that are in use to mark accounts, read more [here](https://docs.nexirift.com/concepts/flags).
